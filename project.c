...
int main()
{
    printf("be samane modiriate ketabkhane khosh amadid. dar soorate tamayol be khorooj ctrl+c ra feshar dahid.\n");
    int running = 1;
    char page[50] = "logIn";
    char type[50];
    ...
    while (running)
    {
        ...
        else if (strcmp(page, "menu") == 0)
        {
            ...
            if (strcmp(type, "1") == 0)
            {
                ...
                printf("1. namayesh list ketab ha\n");
                printf("2. namayesh list aaza va tarikhche daryaft ketab\n");
